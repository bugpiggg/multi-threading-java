package org.bugpiggg.optimizeLatency;
...
public class ImageProcessingEx {
    public static final String SOURCE_FILE = "./many-flower.jpeg";
    public static final String DESTINATION_FILE = "./out/many-flower.jpeg";
